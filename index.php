        ...
        case 'sanpham':
            ...
            case 'sanphamchitiet':
                if (isset($_GET['san_pham_id']) && ($_GET['san_pham_id'] > 0)) {
                    ...
                    $dsbl = load_comments_by_product($san_pham_id);
                ...
                case 'add_comment':
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        $nguoi_dung_id = $_SESSION['username']['nguoi_dung_id'] ?? null; // Gán null nếu không tồn tại

                        $ngaybinhluan = date('Y-m-d H:i:s');
                
                        // Thêm bình luận vào cơ sở dữ liệu
                        insert_comment($san_pham_id, $noi_dung, $nguoi_dung_id, $ngaybinhluan);
                
                        // Chuyển hướng về lại trang chi tiết sản phẩm
                        header("Location: index.php?act=sanphamchitiet&san_pham_id=$san_pham_id");
                    }
                    break;
