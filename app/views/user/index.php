        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">Cây cảnh và phụ kiện trang trí</h4>
                    <h1 class="mb-5 display-3 text-primary">Mang khu vườn nhỏ vào ngôi nhà của bạn</h1>
                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="/chieu2/public/img/s1.jpg"
                                    class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                            </div>
                            <div class="carousel-item rounded">
                                <img src="/chieu2/public/img/s2.jpg" class="img-fluid w-100 h-100 rounded"
                                    alt="Second slide">
                            </div>
                        </div>
